...
from TTS.tts.models.vits2 import Vits, VitsArgs, VitsAudioConfig
...
dataset_config = [
   BaseDatasetConfig(
    formatter="carlos_tcstar3", meta_file_train="metadata_norm.txt", language="es", phonemizer="espeak", path="/home/usuaris/veu/daniel.gonzalbez/recordingsCarlosdePablo"
   )
]   
...
config = VitsConfig(
    ...
    phonemizer='espeak',
    phoneme_language="es",
    phoneme_cache_path=os.path.join('/home/usuaris/veu/daniel.gonzalbez/', "phoneme_cache_esp_def"),
    ...
    test_sentences=[['Hace un buen día para pasear.', '76_norm'],
                    ['Mañana es el mejor día del año!', '72_norm']
    ],
